...
Si les journaux d'archivage requis pour la restauration ne sont pas disponibles à l'emplacement configuré, vous devez monter le snapshot contenant les journaux et spécifier le chemin comme journaux d'archivage externes.
+
