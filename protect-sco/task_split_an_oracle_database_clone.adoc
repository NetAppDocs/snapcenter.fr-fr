...
* Pour plus d'informations sur les opérations de répartition des volumes FlexClone, voir, https://docs.netapp.com/us-en/ontap/volumes/split-flexclone-from-parent-task.html["Séparer un volume FlexClone de son volume parent"]
...
. Sélectionnez la ressource clonée (par exemple, la base de données ou la LUN), puis cliquez sur image:../media/split_clone.gif["séparer le clone"].
