...
summary: Vous devez créer des rôles de cluster ONTAP pour les systèmes ASA r2 afin de ne pas avoir à utiliser le rôle ONTAP admin pour effectuer des opérations dans SnapCenter. 
---
