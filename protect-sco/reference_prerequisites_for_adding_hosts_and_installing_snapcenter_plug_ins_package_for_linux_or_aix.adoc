...
Packs logiciels requis
 a| 
* Java 1.8.x (64 bits) Oracle Java et OpenJDK Flavors
* Java 11 (64 bits) Oracle Java et OpenJDK Flavors
...
|===
Pour obtenir les dernières informations sur les versions prises en charge, reportez-vous à la section https://imt.netapp.com/matrix/imt.jsp?components=108392;&solution=1259&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^].
