...
* Vous devez avoir installé Java 17, Java 11 (pour SnapCenter 6.2 uniquement) sur votre hôte Linux.
+
...
Packs logiciels requis
 a| 
Java 17 (Oracle Java ou OpenJDK), Java 11 (pour SnapCenter 6.2 uniquement)
