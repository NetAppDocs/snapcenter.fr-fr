...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Télécharger JAVA pour Windows"^]
...
* Vous devez avoir activé la connexion SSH par mot de passe pour l'utilisateur root ou non-root.
* Vous devez avoir installé Java 11 sur vos hôtes Linux ou AIX.
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Télécharger JAVA pour Linux"^]
