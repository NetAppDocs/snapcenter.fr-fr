...
--
lien permanent : protect-scu/task_split_a_clone.html
encadré : encadré
mots-clés : clone divisé, SnapCenter
résumé : 'vous pouvez utiliser SnapCenter pour séparer une ressource clonée de la ressource parent. Le clone divisé devient indépendant de la ressource parent.'
---
= diviser un clone
:icons : police
:imagesdir: ../media/
