...
* Vous devez avoir activé la connexion SSH par mot de passe pour l'utilisateur root ou non-root.
* Vous devez avoir installé Java 17, Java 11 (pour SnapCenter 6.2 uniquement) sur vos hôtes Linux ou AIX.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Télécharger Java pour Linux"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["Télécharger Java pour AIX"^]
