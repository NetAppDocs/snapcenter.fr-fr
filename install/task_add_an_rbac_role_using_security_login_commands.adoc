...
Pour simplifier la configuration de ces rôles sur les systèmes de stockage, vous pouvez utiliser l'outil RBAC User Creator for NetApp ONTAP, disponible sur le forum des communautés NetApp.
