...
* Si les bases de données résident sur des LUN RDM VMware, vous devez déployer le plug-in SnapCenter pour VMware vSphere et enregistrer le plug-in avec SnapCenter. Le https://["Documentation du plug-in SnapCenter pour VMware vSphere"] a plus d'informations.
