...
Les configurations prises en charge par le plug-in SnapCenter pour Oracle Database sont répertoriées dans le https://imt.netapp.com/imt/imt.jsp?components=180320;180338;180332;&solution=1257&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^].
