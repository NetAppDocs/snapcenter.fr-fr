...
Pour configurer le certificat CA avec SnapCenter Plug-in for VMware vSphere, voir https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["Créez ou importez un certificat SSL"^].
