...
Pour obtenir la liste complète des nouvelles fonctionnalités et améliorations, consultez link:what's-new-in-snapcenter62.html["Quoi de neuf dans SnapCenter 6.2"].
