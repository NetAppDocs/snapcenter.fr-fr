...
* Java 11 pour SnapCenter 6.2 et versions antérieures sur votre hôte.
+
...
* Si vous utilisez une version de MySQL antérieure à la version 8.0, vous devez installer et activer manuellement le plugin MySQLX. Ce plugin est installé et activé par défaut pour MySQL 8.0 et versions ultérieures.
...
* Vous devez avoir installé Java 17 (Oracle Java ou OpenJDK) pour SnapCenter 6.2.1 et versions ultérieures ou
* Java 11 pour SnapCenter 6.2 et versions antérieures sur votre hôte Windows.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Téléchargez Java pour tous les systèmes d'exploitation"]
