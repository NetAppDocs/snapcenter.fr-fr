...
Pour obtenir des informations de dépannage, reportez-vous à la section https://kb.netapp.com/mgmt/SnapCenter/SnapCenter_MFA_login_error_The_SAML_message_response_1_doesnt_match_the_expected_response_2["La connexion SnapCenter sous plusieurs onglets affiche une erreur MFA"^].
