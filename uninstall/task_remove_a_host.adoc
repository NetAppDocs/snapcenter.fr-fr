...
* Le temps nécessaire pour supprimer un hôte dépend du nombre de sauvegardes et des paramètres de rétention. En effet, les instantanés sont supprimés de chacun des contrôleurs et les métadonnées sont nettoyées.
