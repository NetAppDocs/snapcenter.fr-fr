...
NOTE: À partir de la version 5.0, les utilisateurs SVM admin ne sont pris en charge qu'avec les API REST. Si vous souhaitez créer des rôles à l'aide d'un admin non vServer, vous devez utiliser ZAPI.
