...
Consultez link:https://techdocs.broadcom.com["Broadcom Documentation technique"^] et recherchez la documentation sur le clustering de machines virtuelles sur des hôtes physiques et la création de LUN FC RDM partagés pour les clusters Microsoft.
