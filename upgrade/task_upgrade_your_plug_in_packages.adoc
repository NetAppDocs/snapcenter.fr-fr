...
* Assurez-vous que le pack d’hébergement ASP.NET Core Runtime 8.0.24 (et tous les correctifs 8.0.x ultérieurs) et PowerShell 7.4.13 ou une version ultérieure sont installés sur l’hôte du plug-in Windows.
* Assurez-vous que Java 17 (Oracle Java ou OpenJDK) pour SnapCenter 6.2.1 et versions ultérieures ou Java 11 pour SnapCenter 6.2 et versions antérieures, est installé sur les hôtes de plug-ins Windows et Linux.
