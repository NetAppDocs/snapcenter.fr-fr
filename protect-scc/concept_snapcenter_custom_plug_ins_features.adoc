...
+
SnapCenter utilise la technologie Snapshot de NetApp avec les plug-ins personnalisés SnapCenter pour sauvegarder des ressources. Les copies Snapshot consomment un espace de stockage minimal.
