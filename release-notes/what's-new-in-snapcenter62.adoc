...
summary: La version 6.2 du logiciel SnapCenter inclut plusieurs nouvelles fonctionnalités et améliorations. 
---
...
[role="lead"]
La version 6.2 du logiciel SnapCenter inclut la fonctionnalité étendue suivante.
