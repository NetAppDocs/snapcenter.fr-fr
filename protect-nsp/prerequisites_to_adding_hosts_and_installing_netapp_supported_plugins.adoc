...
* Vous devez avoir installé Java 17 (Oracle Java ou OpenJDK) pour SnapCenter 6.2.1 et versions ultérieures ou
* Java 11 pour SnapCenter 6.2 et versions antérieures sur votre hôte Linux, Windows ou AIX.
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Télécharger Java pour Windows"]
...
+
Si vous utilisez Windows Server 2019 ou Windows Server 2016 pour l’hôte du serveur SnapCenter, vous devez installer Java 17 (Oracle Java ou OpenJDK) pour SnapCenter 6.2.1 et versions ultérieures ou Java 11 pour SnapCenter 6.2 et versions antérieures.

+
link:https://www.oracle.com/java/technologies/downloads/#java17["Télécharger Java pour Linux"]
...
Packs logiciels requis
 a| 
* Java 17 pour SnapCenter 6.2.1 et versions ultérieures, IBM Java ou
* Java 11 pour SnapCenter 6.2 et versions antérieures, IBM Java
