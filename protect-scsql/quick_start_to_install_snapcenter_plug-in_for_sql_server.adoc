...
Pour connaître la configuration minimale requise pour les plug-ins ONTAP et applicatifs, consultez https://["Matrice d'interopérabilité"^]
...
Système d'exploitation (64 bits)
 a| 
Voir https://["Matrice d'interopérabilité"^]
...
=== Téléchargez et installez le serveur SnapCenter

*Étapes*

. Téléchargez le package d'installation du serveur SnapCenter à partir du https://["Site de support NetApp"^] puis double-cliquez sur l'exe.
+
...
=== Ajoutez une licence standard basée sur le contrôleur SnapCenter
...
=== Ajoutez une licence SnapCenter basée sur la capacité
...
=== Configurez les connexions du système de stockage
...
=== Configurez Run as Credentials pour installer le plug-in pour Microsoft SQL Server
...
=== Ajoutez un hôte et installez le plug-in pour Microsoft SQL Server
