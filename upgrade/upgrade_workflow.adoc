...
NOTE: Pour plus d'informations sur la mise à niveau du plug-in SnapCenter pour VMware vSphere, reportez-vous à la section https://["Mettez à niveau le plug-in SnapCenter pour VMware vSphere"^].
