...
** http://["Rapport technique NetApp 4591 : sauvegarde, restauration, réplication et reprise sur incident dans les bases de données"^]
** https://["L'opération échoue avec l'erreur ORA-00308"^]
...
* https://["La base de données Oracle RAC One Node est ignorée pour effectuer les opérations SnapCenter"^]
* https://["Impossible de restaurer le système à partir d'un emplacement SnapMirror ou SnapVault secondaire"^]
* https://["Échec de la restauration à partir d'une sauvegarde d'une incarnation orpheline"^]
