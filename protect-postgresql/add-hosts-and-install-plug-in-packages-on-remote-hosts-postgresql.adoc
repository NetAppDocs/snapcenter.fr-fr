...
+
link:../protect-postgresql/task_configure_gMSA_on_windows_server_2012_or_later.html["Configurez le compte de service géré de groupe sur Windows Server 2016 ou version ultérieure pour PostgreSQL"^]
