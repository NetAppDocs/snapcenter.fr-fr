...
summary: 'Avant d"ajouter un hôte et d"installer les packages de plug-ins, vous devez respecter toutes les exigences. Les plug-ins pris en charge par NetApp peuvent être utilisés dans les environnements Windows et Linux.' 
---
...
* Pour les plug-ins pris en charge par NetApp, assurez-vous d'avoir ajouté le hachage SHA512 du fichier de plug-in pris en charge par NetApp au fichier _custom_plugin_checksum_list_.
+
