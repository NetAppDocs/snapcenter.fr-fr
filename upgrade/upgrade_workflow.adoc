...
IMPORTANT: Par exemple, si vous utilisez SnapCenter version 4.5.x et que vous souhaitez effectuer une mise à niveau vers 4.8, vous devez d'abord mettre à niveau vers 4.6.x, puis effectuer une mise à niveau par déploiement vers 4.8.
