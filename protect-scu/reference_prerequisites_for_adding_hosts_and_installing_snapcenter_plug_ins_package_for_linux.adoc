...
NOTE: La clé RSA est le seul format de clé SSH pris en charge pour SnapCenter. Consultez l’article de la Knowledge Base link:https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_an_RSA_key_for_SnapCenter_SSH_Key_Based_credential["Comment créer une clé RSA pour l'identifiant basé sur une clé SSH de SnapCenter"^] pour savoir comment créer la clé SSH.
...
* Java 11 pour SnapCenter 6.2 et les versions antérieures sur votre hôte Linux.
+
...
+
Pour plus d'informations sur les téléchargements Java, consultez link:https://www.oracle.com/java/technologies/downloads/#java17["Téléchargez Java pour tous les systèmes d'exploitation"^].
...
Packs logiciels requis
 a| 
* Java 17 (Oracle Java ou OpenJDK) pour SnapCenter 6.2.1 et versions ultérieures ou
...
|===
Pour obtenir les informations les plus récentes sur les versions prises en charge, consultez le https://imt.netapp.com/imt/imt.jsp?components=180320;180338;&solution=1257&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^].
