...
.Avant de commencer
* Vous devez avoir installé le pack d'hébergement ASP.NET Core Runtime 8.0.24 (et tous les correctifs 8.0.x ultérieurs).
* Vous devez avoir installé PowerShell 7.4.13 ou une version ultérieure.
