...
* Pour connaître les prérequis et les limitations de SnapMirror Business Continuity (SM-BC), reportez-vous à https://docs.netapp.com/us-en/ontap/smbc/considerations-limits.html#volumes["Limites des objets pour la continuité de l'activité SnapMirror"].
