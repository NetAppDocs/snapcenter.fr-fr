...
+
Pour plus d'informations sur la modification du paramètre asm_diskstring, reportez-vous à la section https://["Comment ajouter des chemins de disque à asm_diskstring"^].
...
+
**** https://["Guide d'installation et de configuration des utilitaires d'hôtes Linux"^]
**** https://["Guide d'installation et de configuration des utilitaires hôtes AIX"^]
