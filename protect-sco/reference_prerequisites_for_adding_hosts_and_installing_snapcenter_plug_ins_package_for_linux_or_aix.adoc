...
* Vous devez avoir installé Java 17, Java 11 (pour SnapCenter 6.2 uniquement) sur votre hôte Linux ou AIX.
+
...
NOTE: Assurez-vous d'avoir installé uniquement l'édition certifiée de Java 17, Java 11 (pour SnapCenter 6.2 uniquement) sur l'hôte Linux.
...
Packs logiciels requis
 a| 
Java 17 (Oracle ou OpenJDK), Java 11 (pour SnapCenter 6.2 uniquement)
...
Packs logiciels requis
 a| 
IBM Java 17, IBM Java 11 (pour SnapCenter 6.2 uniquement)
