...
summary: 'Vous devez configurer le certificat d"autorité de certification avec les services de plug-in d"hôte Windows pour activer le certificat numérique installé.' 
---
