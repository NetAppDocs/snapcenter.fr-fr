...
* Vous devez avoir installé Java 17 sur votre hôte Linux, Windows ou AIX.
+
...
* Vous devez avoir installé Java 17 sur votre hôte Linux.
+
Si vous utilisez Windows Server 2019 ou Windows Server 2016 pour le serveur hôte SnapCenter, vous devez installer Java 17.
