...
* Le cas échéant, installez Java 17 (Oracle Java ou OpenJDK) pour SnapCenter 6.2.1 et versions ultérieures ou
* Java 11 pour SnapCenter 6.2 et versions antérieures sur l'hôte du plug-in.
