...
Vous pouvez éventuellement effectuer plusieurs procédures d'installation et de configuration à l'aide des applets de commande PowerShell. Vous devez utiliser PowerShell 7.4.13 ou une version ultérieure.
...
* Outils de gestion Web
 ...
 a| 
+Fonctionnalités du framework .NET+
 a| 
* ASP.NET Core Runtime 8.0.24 (et tous les correctifs 8.0.x ultérieurs) Hosting Bundle
