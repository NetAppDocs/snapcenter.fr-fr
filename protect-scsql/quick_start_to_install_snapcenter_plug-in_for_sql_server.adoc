...
Pour connaître la configuration minimale requise pour les plug-ins ONTAP et applicatifs, consultez https://imt.netapp.com/matrix/imt.jsp?components=117008;&solution=1259&isHWU&src=IMT["Matrice d'interopérabilité"^].
...
NOTE: Si vous avez le serveur SnapCenter sur le même hôte où le référentiel SnapCenter est installé, il est recommandé d'avoir 15 Go.
