...
NOTE: SnapCenter prend également en charge l'équilibrage de la charge AWS Elastic Load Balancing (ELB) et Azure.
...
+
Pour plus d'informations, voir https://docs.netapp.com/us-en/snapcenter-cmdlets/index.html["Guide de référence de l'applet de commande du logiciel SnapCenter"^].
