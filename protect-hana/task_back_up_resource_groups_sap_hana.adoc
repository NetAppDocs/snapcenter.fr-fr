...
+
Vous pouvez effectuer une recherche dans le groupe de ressources en entrant le nom du groupe de ressources dans la zone de recherche ou en sélectionnant image:../media/filter_icon.png[""], puis en sélectionnant la balise. Vous pouvez ensuite sélectionner image:../media/filter_icon.png[""] pour fermer le volet de filtre.
