...
* Vous devez avoir installé Java 17, Java 11 (pour SnapCenter 6.2 uniquement) sur votre hôte Linux, Windows ou AIX.
+
...
+
Si vous utilisez Windows Server 2019 ou Windows Server 2016 pour l’hôte du serveur SnapCenter, vous devez installer Java 17, Java 11 (pour SnapCenter 6.2 uniquement).
...
Packs logiciels requis
 a| 
Java 17, Java 11 (pour SnapCenter 6.2 uniquement), IBM Java
