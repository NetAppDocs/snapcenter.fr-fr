...
NOTE: À partir de SnapCenter 5.0, les utilisateurs d'administrateurs de cluster ne sont pris en charge que par les API REST. Si vous souhaitez créer des rôles à l'aide d'un autre administrateur de cluster, vous devez utiliser ZAPI.
