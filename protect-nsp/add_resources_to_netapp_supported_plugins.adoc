...
* ORACLE_EXPORT_PARAMETERS spécifie si vous pouvez exporter des variables d'environnement lors de l'exécution de _bin/su_. La valeur de ORACLE_EXPORT_PARAMETERS doit être définie sur *y*.
