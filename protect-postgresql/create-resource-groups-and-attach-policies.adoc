...
extension_fichier
 a| 
Spécifie l'extension du fichier journal d'archivage.

Par exemple, si le journal d'archivage est log_backup_0_1.log, spécifiez .log comme extension de fichier.
