...
* Assurez-vous que PowerShell 7.4.13 est installée sur l'hôte du plug-in Windows.
* Assurez-vous que Java 17 (Oracle Java ou OpenJDK) est installé sur les hôtes de plug-ins Windows et Linux (ou Java 11 pour SnapCenter 6.2 uniquement).
