...
NOTE: Après la mise à niveau vers SnapCenter 6.2.1 (serveur et plug-ins) et ONTAP 9.17.1, SnapCenter remplace les groupes de cohérence plats par des groupes de cohérence hiérarchiques lors de la première sauvegarde planifiée.
