...
* Vous devez avoir installé Java 17 sur votre hôte Linux ou AIX.
+
...
NOTE: Assurez-vous d'avoir installé uniquement l'édition certifiée de Java 17 sur l'hôte Linux.
