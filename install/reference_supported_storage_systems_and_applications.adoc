...
+
Pour plus d'informations sur Amazon FSX pour NetApp ONTAP, consultez https://["Documentation Amazon FSX pour NetApp ONTAP"^].

* SnapCenter prend en charge la protection de différentes applications et bases de données.
+
Pour plus d'informations sur les applications et bases de données prises en charge, reportez-vous à la section https://["Matrice d'interopérabilité NetApp"^].
