...
+
Pour EMS, reportez-vous à la section https://["Gérer la collecte de données EMS"]
...
https://["Le clonage peut échouer ou prendre plus de temps avec la valeur TCP_TIMEOUT par défaut"]

https://["Le clone de base de données de l'instance de cluster de basculement échoue"]
