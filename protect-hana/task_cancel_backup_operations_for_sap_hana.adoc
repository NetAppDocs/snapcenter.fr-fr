...
'''
Permalink: Protect-hana/task_cancel_backup_operations_for_sap_hana.html encadré: Mots-clés de l'encadré: résumé: 'Vous pouvez annuler les opérations de sauvegarde en file d'attente.' --- = Annuler les opérations de sauvegarde pour SAP HANA :icons: Font :imagesdir: ../media/
