...
. Décidez si vous souhaitez créer une règle basée sur les copies Snapshot pour sauvegarder des copies Snapshot cohérentes au niveau des applications du cluster.
