...
Par défaut, toutes les connexions des systèmes ASA, AFF ou FAS à ONTAP passent par ZAPI. L'API REST peut être activée pour des versions spécifiques d'ONTAP.
