...
+
https://["Stockage NetApp Storage Automation Store"^]
...
+
Pour plus d'informations sur les API REST, voir https://["Présentation de l'API REST"].

+
Pour plus d'informations sur les applets de commande Windows, voir https://["Guide de référence de l'applet de commande du logiciel SnapCenter"^].

+
Pour plus d'informations sur les commandes UNIX, voir https://["Guide de référence sur les commandes du logiciel SnapCenter"^].
...
+
Ces plug-ins personnalisés sont pris en charge par la communauté et peuvent être téléchargés depuis le https://["Stockage NetApp Storage Automation Store"^].
...
Des exemples de plug-in personnalisés MySQL, DB2 et MongoDB pour le logiciel SnapCenter peuvent être téléchargés à partir du https://["Stockage NetApp Storage Automation Store"^].
